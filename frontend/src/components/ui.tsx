...
const TAB_SOURCES: Partial<Record<TabId, Record<Locale, string[]>>> = {
  weather: {
    en: [
      ...
      "Seven-day rain and drying: Open-Meteo daily values.",
      "Soil day-to-day: wetting/drying memory (same rain runs off more if soil is already wet).",
      "Compare: two district snapshots, same method.",
    ],
    hi: [
      "आकाश, बारिश, हवा, मिट्टी: Open-Meteo (मॉडल; गाँव का रेन-गेज नहीं)।",
      "7 दिन बारिश/सुखना: Open-Meteo दैनिक अंक।",
      "मिट्टी: गीली शाखा पर वही बारिश ज्यादा बहती है।",
      "तुलना: दो ज़िलों का एक जैसा स्नैपशॉट।",
    ],
    bn: [
      "আকাশ, বৃষ্টি, হাওয়া, মাটি: Open-Meteo (মডেল, গ্রামের বৃষ্টিমাপক নয়)।",
      "৭ দিন বৃষ্টি/শুকনো: Open-Meteo দৈনিক সংখ্যা।",
      "মাটি: ভেজা শাখায় একই বৃষ্টি বেশি বয়ে যায়।",
      "তুলনা: দুই জেলার একই পদ্ধতি।",
    ],
  },
  home: {
  ...
  air_quality: {
    en: ["Air number: CPCB National AQI via data.gov.in when a station is near; otherwise the map says so."],
    hi: ["हवा का अंक: पास हो तो CPCB / data.gov.in।"],
    bn: ["বাতাসের সংখ্যা: কাছে স্টেশন থাকলে CPCB / data.gov.in।"],
  },
  marine: {
    en: ["Earthquake / sea cards only repeat official lists (USGS, INCOIS), they do not predict."],
    hi: ["भूकंप/समुद्र केवल आधिकारिक सूची दोहराते हैं।"],
    bn: ["ভূমিকম্প/সমুদ্র শুধু সরকারি তালিকা বলে।"],
  },
  advisor: {
